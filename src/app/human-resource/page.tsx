      ...
      <div className="bg-[url('/images/human-resource.jpg')] bg-cover bg-center">
        <div className=" max-w-7xl m-auto px-5  py-15 md:py-40">
          ...
          <p className=" mx-auto leading-relaxed text-sm font-normal text-white inter-text text-center">
            ...
            we maximize HR efficiency, <br />
            implement fit-for-purpose policies, and deliver measurable
            improvements in culture, retention, and productivity—whether you’re
            a fast-growing startup or a large enterprise.
          </p>
        </div>
      </div>
      <section className=" ">
        <div className="container">
          ...
          <div className="flex flex-col text-center w-full mb:10  md:mb-20">
            <h1 className="sm:text-4xl text-2xl font-bold  mb-4 text-primary">
